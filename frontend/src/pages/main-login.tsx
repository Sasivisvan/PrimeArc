...
const LoginPage = () => {
    ...
    // 1. Loading State: To disable the button while "awaiting" the backend
    const [isLoading, setIsLoading] = useState(false);

    // 2. Error State: To show red text if login fails
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    ...
                    <div>
                        <button
                            ...
                            className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-lg text-white bg-blue-600 hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                            {isLoading ? (
